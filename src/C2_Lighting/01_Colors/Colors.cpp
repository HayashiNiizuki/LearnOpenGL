...
int main() {
    ...
    Shader lightShader("./01_Colors/shader_files/shader.vs", "./01_Colors/shader_files/shader.fs");
    Shader cubeShader("./01_Colors/lighting_shader/shader.vs", "./01_Colors/lighting_shader/shader.fs");
